...
def main():
    ...
    ds = load_dataset(
        "hazemessam/ddg",
        data_files={"train": "S2648.csv", "validation": "ssym.csv", "test": "ssym_r.csv"})
    ...
    test_datasets = load_dataset(
        "hazemessam/ddg",
        data_files={"train": "myoglobin.csv", "validation": "myoglobin_r.csv", "test": "p53.csv"})

    myoglobin_ds = SingleMutationDatasetV2(test_datasets["train"], swap=False)
    myoglobin_r_ds = SingleMutationDatasetV2(test_datasets["validation"], swap=False)
